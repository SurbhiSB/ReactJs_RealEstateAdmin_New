    ...
    <div className="flex">
      ...
      <div className="flex-1">
        ...
        <div className="p-4">
          ...
          {/* Site Name & Date */}
          <div className="bg-white shadow-md rounded border border-gray-300 mb-6 p-4">
          ...
          {/* Table View */}
          {/* Table View */}
<div className="bg-white shadow-md rounded border border-gray-300 p-4 overflow-auto">
