  ...
  return (
    ...
    <div className="p-4">
      ...
      <div className="mb-4 flex gap-2">
        <button className="bg-gray-700 text-white px-3 py-1 rounded" onClick={() => navigator.clipboard.writeText(JSON.stringify(data))}>Copy</button>
        <button className="bg-gray-700 text-white px-3 py-1 rounded" onClick={exportToExcel}>Excel</button>
        <button className="bg-gray-700 text-white px-3 py-1 rounded" onClick={exportToPDF}>PDF</button>
        <button className="bg-gray-700 text-white px-3 py-1 rounded" onClick={handlePrint}>Print</button>
      </div>
